...
namespace ERGASIA
{
    public partial class Form4 : Form
    {
        ...
        public void gOLDCLASSToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            GoldClass.Visible = true;
            Aithousa1.Visible = false;
            Comfort.Visible = false;
            CinemaComplexKids.Visible = false;
        }

        public void αίθουσα1ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            GoldClass.Visible = false;
            Aithousa1.Visible = true;
            Comfort.Visible = false;
            CinemaComplexKids.Visible = false;
        }

        public void αΙΘΟΥΣΑ2ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            GoldClass.Visible = false;
            Aithousa1.Visible = false;
        ...
        public void gOLDCLASSToolStripMenuItem_Click(object sender, EventArgs e)
        {
            GoldClass.Visible = false;
            Aithousa1.Visible = false;
            Comfort.Visible = false;
            CinemaComplexKids.Visible = true;
        }
