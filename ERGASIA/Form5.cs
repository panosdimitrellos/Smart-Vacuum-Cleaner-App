...
namespace ERGASIA
{
    public partial class Form5 : Form
    {
        ...
        public static string SetValueForMovieName = "";
        ...
        private void button3_panel1_Click(object sender, EventArgs e)
        {
            Form7 f7 = new Form7();
            SetValueForMovieName = label3.Text;
            f7.ShowDialog();
        }

        private void button6_panel2_Click(object sender, EventArgs e)
        {
            Form7 f7 = new Form7();
            SetValueForMovieName = label6.Text;
            f7.ShowDialog();
        }

        private void button3_panel3_Click(object sender, EventArgs e)
        {
            Form7 f7 = new Form7();
            SetValueForMovieName = label9.Text;
            f7.ShowDialog();
        }

        private void button3_panel4_Click(object sender, EventArgs e)
        {
            Form7 f7 = new Form7();
            SetValueForMovieName = label12.Text;
            f7.ShowDialog();
        }
        ...
        {
            Form7 f7 = new Form7();
            SetValueForMovieName = label15.Text;
            f7.ShowDialog();
        }
        ...
        {
            Form7 f7 = new Form7();
            SetValueForMovieName = label18.Text;
            f7.ShowDialog();
        }
        ...
        {
            Form7 f7 = new Form7();
            SetValueForMovieName = label22.Text;
            f7.ShowDialog();
        }
        ...
        {
            Form7 f7 = new Form7();
            SetValueForMovieName = label25.Text;
            f7.ShowDialog();
